...
import { Box, Boxes, Edit } from "lucide-react";
    ...
    <AnimatePresence mode="wait">
      {shouldShowHeader && (
        <motion.header 
          ...
          className="border-b-2 border-black shrink-0 bg-background z-50 relative"
        >
          <div className="w-full px-4 py-3 flex items-center justify-between relative min-h-[72px]">
            <div className="flex items-center gap-3 absolute left-4 top-1/2 -translate-y-1/2 z-10">
              <Link href="/" className="flex items-center gap-3">
                ...
                <span className={`text-3xl ${bungee.className} lowercase cursor-pointer`}>PolyCraft</span>
              </Link>
            </div>
